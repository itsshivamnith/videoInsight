...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24 pb-12 px-4 sm:px-6 lg:px-8 font-sans">
      <Helmet>
        <title>Contact Us - VideoInsight</title>
        <meta
          name="description"
          content="Get in touch with VideoInsight. Connect with us on social media or send us a message."
        />
        <link rel="canonical" href="https://videoinsight.netlify.app/contact" />
      </Helmet>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Kolkata India,700058</p>
                </div>
              </div>
            ...
            <div className="border-t border-gray-100 pt-8">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="https://www.linkedin.com/in/saheb142003"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://www.instagram.com/saheb142003"
                  target="_blank"
                  rel="noopener noreferrer"
